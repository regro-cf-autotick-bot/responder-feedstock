About responder-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/responder-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1852&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/responder-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `responder` can be installed with `conda`:
...
```
mamba install responder
```

It is possible to list all of the versions of `responder` available on your platform with `conda`:
...
```
mamba search responder --channel conda-forge
```
...
mamba repoquery search responder --channel conda-forge

# List packages depending on `responder`:
mamba repoquery whoneeds responder --channel conda-forge

# List dependencies of `responder`:
mamba repoquery depends responder --channel conda-forge
```
